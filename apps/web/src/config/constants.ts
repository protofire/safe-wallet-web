...
export const HELP_CENTER_URL = 'https://protofire.io/services/solution/safe-deployment'
...
export const BRAND_NAME = process.env.NEXT_PUBLIC_BRAND_NAME || (IS_OFFICIAL_HOST ? 'Safe{Wallet}' : 'Protofire Safe')
